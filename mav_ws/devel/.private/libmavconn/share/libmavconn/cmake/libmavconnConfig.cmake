...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/pi/src/mav_ws/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/pi/src/mav_ws/devel/.private/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /home/pi/src/mav_ws/install)
...
if(NOT "/home/pi/src/mav_ws/src/mavros/libmavconn/include;/usr/include;/opt/ros/kinetic/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/src/mav_ws/src/mavros/libmavconn/include;/usr/include;/opt/ros/kinetic/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/src/mav_ws/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
    _list_append_unique(libmavconn_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mavconn;/usr/lib/arm-linux-gnueabihf/libboost_system.so;/usr/lib/arm-linux-gnueabihf/libconsole_bridge.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/src/mav_ws/devel/.private/libmavconn/lib;/home/pi/src/mav_ws/devel/lib;/opt/ros/kinetic/lib)
